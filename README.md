...
Each command (and command set) exists in its own file, in its own class to make it modular and easy to find. Shared logic lives in resuable utility modules, with the intention of limiting duplicate code.

The project aims to:
- Lower the barrier of entry for new Discord bot developers.
- Encourage modulation for expanded and continued use.
- Provide a list of pre-built commands to quicken development of new bots.
- Be a good resource for new Discord bot developers to learn from.
- Create a strong community with an emphasis on maintainablity. 

---

# Table of Contents
This is the README file. If you are looking for:
- License (containing license details)
- Contributing (containing details on how to contribute to the project)
...
3. Confirm your Mlti-Factor Authentication, if set up.
![Multiauth](readme_images/multiauth.png.png)
